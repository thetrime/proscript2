...
#define must_be_character_code(a) (must_be_integer(a) && ((getConstant(a, NULL).integer_data >= 0 && getConstant(a, NULL).integer_data <= 65535) || representation_error(characterCodeAtom, a)))
