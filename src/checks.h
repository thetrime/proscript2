...
//#define must_be_predicate_indicator(a) ((TAGOF(a) == COMPOUND_TAG && FUNCTOROF(a) == predicateIndicatorFunctor && must_be_atom(ARGOF(a, 0)) && must_be_positive_integer(ARGOF(a, 1))) || type_error(predicateIndicatorAtom, a))
