...
module.exports = {emptyListAtom: new AtomTerm("[]"),
		  ...
		  failAtom: new AtomTerm("fail"),
                  ...
                  atomFunctor: new Functor(new AtomTerm("atom"), 1),
                  ...
                  discontiguousFunctor: new Functor(new AtomTerm("discontiguous"), 1),
                  initializationFunctor: new Functor(new AtomTerm("initialization"), 1),
